...
import { useUpdateOrderHeaderMutation } from '../../../apis';
...
export const OrderSummary=({data,userInput}:orderSummaryProps)=>{
...
<div>
      ...
      <div className="mt-3">
        ...
        <div className="border py-3 px-2">
          ...
          <div className="p-3">
            {data.cartItems?.map((cartItem:cartItemModel,index:number)=>{return (
